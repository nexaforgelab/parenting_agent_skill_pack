...
SKILL_ID = "family_schedule_manager"
SKILL_NAME = "家庭日程管理 Agent"
...
def run(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    from planner import (
        analyze_schedule_trends, detect_conflicts, detect_anomalies,
        generate_personalized_recommendations, aggregate_weekly_stats
    )
    ...
    recommendations = generate_personalized_recommendations(
        records, trends, payload.get("child_profile", {}), alerts
    )
