"""Planning engine for 辅食添加规划 Agent.
...
SKILL_FLOW = ['输入宝宝月龄、过敏史、已尝试食材', '分析睡眠、喂养、活动规律', '找出夜醒、短睡、晚睡原因', '生成适合月龄的作息建议', '每天提醒执行', '每周复盘']
...
DEFAULT_DELIVERABLES = ['每周辅食表', '食材尝试记录', '过敏观察表', '采购清单']
