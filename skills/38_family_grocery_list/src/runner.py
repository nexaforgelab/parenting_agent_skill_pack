...
SKILL_ID = "family_grocery_list"
SKILL_NAME = "家庭买菜清单 Agent"
...
def run(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    from planner import analyze_purchase_trends, detect_anomalies, generate_personalized_recommendations, aggregate_weekly_stats
