...
SKILL_ID = "child_nutrition_meal_planner"
SKILL_NAME = "儿童营养餐 Agent"
...
def run(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    from planner import analyze_meal_trends, detect_anomalies, generate_personalized_recommendations, aggregate_weekly_stats
