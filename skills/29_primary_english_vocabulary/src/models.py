...
class LearningRecord:
    ...
    def validate(self) -> List[str]:
        ...
        if self.correct_count < 0:
            errors.append("correct_count 不能为负数")
    ...
    def get_accuracy_rate(self) -> float:
        ...
        if self.words_practiced == 0:
            return 0.0
        return round(self.correct_count / self.words_practiced, 2)

    def is_passed(self, threshold: float = 60.0) -> bool:
        """判断是否达标"""
