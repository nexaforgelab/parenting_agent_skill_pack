...
SKILL_ID = "weekend_family_activity"
SKILL_NAME = "周末亲子活动 Agent"
...
def run(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    from planner import analyze_activity_trends, detect_anomalies, generate_personalized_recommendations, aggregate_weekly_stats
