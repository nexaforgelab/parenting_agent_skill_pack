...
class MathActivity:
    ...
    activity_id: str
    activity_name: str
    topic: Union[str, MathTopic]
    description: str
    materials_needed: List[str] = field(default_factory=list)
    estimated_duration_minutes: int = 15
    difficulty_level: str = "低"
    ...
    def __post_init__(self):
        ...
        if isinstance(self.topic, str):
            try:
                self.topic = MathTopic(self.topic)
            except ValueError:
                self.topic = MathTopic.COUNTING
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "topic": self.topic.value if isinstance(self.topic, Enum) else self.topic,
...
class ProgressRecord:
    ...
    mastery_level: Union[str, MathSkillLevel]
    engagement: Union[str, EngagementLevel]
    ...
    def __post_init__(self):
        ...
        if isinstance(self.mastery_level, str):
            try:
                self.mastery_level = MathSkillLevel(self.mastery_level)
            except ValueError:
                self.mastery_level = MathSkillLevel.INTRODUCTORY
        if isinstance(self.engagement, str):
            try:
                self.engagement = EngagementLevel(self.engagement)
            except ValueError:
                self.engagement = EngagementLevel.MEDIUM
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "mastery_level": self.mastery_level.value if isinstance(self.mastery_level, Enum) else self.mastery_level,
            "engagement": self.engagement.value if isinstance(self.engagement, Enum) else self.engagement,
...
class WeeklyStats:
    ...
    average_daily_activities: float = 0.0
    mastered_activities: int = 0
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_daily_activities": round(self.average_daily_activities, 2),
            "mastered_activities": self.mastered_activities,
